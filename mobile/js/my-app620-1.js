...
var ajaxDomain               = 'http://localhost/Ag/AgeingAppDev/t2/AgeingAppDev-master/public';
...
myApp.onPageInit('service', function (page) {
    ...
    ajaxServiceSlug = '/api/' + (page.query.slug !== undefined ? page.query.slug : nav.attr('href').split('slug=')[1]);
