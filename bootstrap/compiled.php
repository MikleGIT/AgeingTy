...
class Application extends Container implements HttpKernelInterface, TerminableInterface, ResponsePreparerInterface
{
    ...
    {
        return 'C:\\phpStudy2016\\WWW\\AgeingAppDev-master\\vendor\\laravel\\framework\\src\\Illuminate\\Foundation' . '/start.php';
    }
    ...
    public function handle($level, $message, $file = 'unknown', $line = 0, $context = array())
    {
        ...
        if ($this->displayErrors && error_reporting() & $level && $this->level & $level) {
            if (!class_exists('Symfony\\Component\\Debug\\Exception\\ContextErrorException')) {
                require 'C:\\phpStudy2016\\WWW\\AgeingAppDev-master\\vendor\\symfony\\debug\\Symfony\\Component\\Debug' . '/Exception/ContextErrorException.php';
            }
            if (!class_exists('Symfony\\Component\\Debug\\Exception\\FlattenException')) {
                require 'C:\\phpStudy2016\\WWW\\AgeingAppDev-master\\vendor\\symfony\\debug\\Symfony\\Component\\Debug' . '/Exception/FlattenException.php';
            }
            ...
            if (is_array($exceptionHandler) && $exceptionHandler[0] instanceof ExceptionHandler) {
                ...
                if (!class_exists('Symfony\\Component\\Debug\\Exception\\DummyException')) {
                    require 'C:\\phpStudy2016\\WWW\\AgeingAppDev-master\\vendor\\symfony\\debug\\Symfony\\Component\\Debug' . '/Exception/DummyException.php';
                }
...
class PrettyPageHandler extends Handler
{
    ...
    public function handle()
    {
        ...
        if (!($resources = $this->getResourcesPath())) {
            $resources = 'C:\\phpStudy2016\\WWW\\AgeingAppDev-master\\vendor\\filp\\whoops\\src\\Whoops\\Handler' . '/../Resources';
        }
